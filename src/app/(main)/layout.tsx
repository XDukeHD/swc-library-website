...
export const metadata: Metadata = {
  ...
  description:
    "Download safe, fast, and verified Nintendo Switch backup ROMs. Browse the latest NSP and XCI games, updates, and DLCs for your emulation or modded console.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Your safe haven for Nintendo Switch backup ROMs. Download verified NSP/XCI games, updates, and DLCs with an active community.",
  ...
  twitter: {
    ...
    description:
      "Download verified NSP and XCI backups for Nintendo Switch. Safe links, updates, and DLCs.",
